...
export const DATASETS: readonly DatasetSpec[] = [
  ...
  // ProfessionGetInfo has NO 'ID' and NO 'Name' key - only gendered name variants.
  ...
  { key: 'sprachen', fn: 'SpracheGetInfo', count: 101, zeroBased: true, fields: ['Name', 'Werke'] },
  { key: 'traditionen', fn: 'TraditionGetInfo', count: 61, zeroBased: true, fields: ['Name', 'Werke'] },
];
